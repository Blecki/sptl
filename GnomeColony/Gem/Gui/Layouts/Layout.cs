...
namespace Gem.Gui
{
    public static class Layout
    {
		...
		public static Rectangle PadItem(Rectangle what, int Padding)
		{
			return new Rectangle(what.X + Padding, what.Y + Padding, what.Width - (2 * Padding), what.Height - (2 * Padding));
		}
    }
}
